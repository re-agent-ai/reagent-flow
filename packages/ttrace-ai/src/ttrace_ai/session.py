...
from ttrace_ai._context import _active_session
from ttrace_ai.exceptions import SessionClosedError
from ttrace_ai.models import Trace
from ttrace_ai.recorder import Recorder
...
class Session:
    ...
    def _save(self) -> None:
        ...
        from ttrace_ai.storage.json import save_trace
    ...
    def assert_called(self, tool_name: str) -> None:
        ...
        from ttrace_ai.assertions import assert_called
    ...
    def assert_never_called(self, tool_name: str) -> None:
        ...
        from ttrace_ai.assertions import assert_never_called
    ...
    def assert_called_before(self, first: str, second: str) -> None:
        ...
        from ttrace_ai.assertions import assert_called_before
    ...
    def assert_tool_succeeded(self, tool_name: str) -> None:
        ...
        from ttrace_ai.assertions import assert_tool_succeeded
    ...
    def assert_max_turns(self, n: int) -> None:
        ...
        from ttrace_ai.assertions import assert_max_turns
    ...
    def assert_total_duration_under(self, *, ms: float) -> None:
        ...
        from ttrace_ai.assertions import assert_total_duration_under
    ...
    def assert_matches_baseline(self, *, base_dir: str | None = None) -> None:
        ...
        from ttrace_ai.diff import diff_traces
        from ttrace_ai.storage.json import load_golden
