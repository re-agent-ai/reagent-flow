"""Tests for reagent_ai.models."""

from reagent_ai.models import LLMCall, Message, ToolCall, ToolResult, Trace, Turn
...
def test_trace_serialization_roundtrip() -> None:
    ...
    from reagent_ai.models import trace_from_dict, trace_to_dict
