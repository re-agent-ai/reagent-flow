...
```
tool 'get_release_info' result field 'ci.coverage': expected float, got str

AGENT STACK TRACE — gatherer
================================
Turn 0: get_release_info(version="v2.3.1")
  → {"release_version": "v2.3.1", "ci": {"pipeline": "passed", "coverage": "87.3"}, ...}
```
